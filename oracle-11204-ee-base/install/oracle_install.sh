...
wget -q -O linux.x64_11gR2_database_1of2.zip http://172.17.0.1/Linux-x86-64/p13390677_112040_Linux-x86-64_1of7.zip
echo 'Downloading linux.x64_11gR2_database_2of2.zip'
wget -q -O linux.x64_11gR2_database_2of2.zip http://172.17.0.1/Linux-x86-64/p13390677_112040_Linux-x86-64_2of7.zip
echo 'Unzipping'
...
su oracle -c 'cd /home/oracle/database && ./runInstaller -ignorePrereq -ignoreSysPrereqs -silent -responseFile /install/db_install_11204.rsp -waitForCompletion 2>&1'
